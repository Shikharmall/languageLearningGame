    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2 ">
          ...
          <NavLink end to="/leaderboard" className="block">
            <div className="flex">
              <div>
            ...
            <ul className="mt-3">
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname === "/" ||
                  (pathname.includes("leaderboard") && "bg-slate-900")
                }`}
              >
                <NavLink
                  end
              ...
              >
                ...
                {/*<SidebarLinkGroup
                activecondition={
                  pathname === "/" || pathname.includes("society")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          ...
                          {/*<li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/society/societymembers/65392f2b5d3d3a1e4df07bb8"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-indigo-500"
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("userdetails") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("languagegame") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="/languagegame"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes("languagegame")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                  }`}
                >
              ...
              {/*<li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("developers") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="/developers/tickets"
                  className={`block text-slate-200 truncate transition duration-150 ${
